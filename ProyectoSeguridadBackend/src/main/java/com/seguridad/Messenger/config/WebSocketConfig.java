...
import com.seguridad.Messenger.websocket.crypto.WsCryptoInboundInterceptor;
...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    private final WsCryptoInboundInterceptor cryptoInboundInterceptor;
    ...
    public void configureClientInboundChannel(ChannelRegistration registration) {
        // CONNECT valida Bearer; SEND hacia /app/... debe venir cifrado.
        registration.interceptors(authInterceptor, cryptoInboundInterceptor);
    }
