...
public class Mensaje {
    ...
    @Column(name = "cifrado_alg")
    private String cifradoAlg;

    @Column(name = "cifrado_key_id")
    private String cifradoKeyId;

    @Column(name = "cifrado_iv", columnDefinition = "TEXT")
    private String cifradoIv;
